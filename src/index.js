...
(function () {
  ...
  const selectHandler = (e, button) => button.parentNode.classList.toggle('active');
  ...
  dropDownListButtons.forEach((button) => button.addEventListener('click', (e) => selectHandler(e, button)));
